...
export default function Home() {
  ...
  <Row xs={2} md={2} className="g-4">
        ...
        <Col key={1}>
          <Card>
          <Card.Body>
            <Card.Img variant="top" style={{ marginBottom:'20px', height: '12rem' }} src="https://www.goodnet.org/photos/620x0/28755_hd.jpg" />
        ...
        <Col key={2}>
          <Card>
            <Card.Body>
            <Card.Img variant="top" style={{ marginBottom:'20px', height: '12rem' }} src="https://massaya.ca/cdn/shop/files/massage-couple-en-meme-temps-a-domicile-massaya-duo.webp?v=1713754427&width=1920" />
